!(function (n) {
  ...
  function e() {
    ...
    n(window).mousemove(function (e) {
      ...
      n("a, .is-hoverable")
        .mouseenter(function () {
          o.css({ transform: "scale(2.2)" });
        })
        .mouseleave(function () {
          o.css({ transform: "scale(1)" });
        }),
      n(".btn, .nav-link")
        .mouseenter(function () {
          o.css({ transform: "scale(0)" });
        })
        .mouseleave(function () {
          o.css({ transform: "scale(1)" });
        });
  ...
  function a() {
    new Swiper(".swiper.swiper-projects", {
      ...
      breakpoints: {
        ...
        991: { slidesPerView: 2, spaceBetween: 100 },
      },
    });
  }
  function s() {
  ...
  barba.use(barbaCss),
    barba.init({
      transitions: [
        { name: "loader-entry", beforeOnce() {}, once() {}, afterOnce() {} },
        {
          name: "loader",
          to: { namespace: ["loader"] },
          leave() {},
